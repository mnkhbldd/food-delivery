...
export const MainPageFooter = () => {
  ...
  const phrases = Array.from({ length: 8 }, (_, index) => (
    <p
      key={index}
      className="text-[30px] text-white font-semibold inline-block px-[34px]"
    >
  ...
  return (
    <div className="bg-[#18181B] h-[755px] w-full flex flex-col justify-around items-center overflow-hidden">
      <div className=" w-full bg-[#EF4444] py-7 overflow-hidden top-[60px]">
        <div className="scroll-wrapper whitespace-nowrap inline-block">
          {phrases}
          {phrases}
        </div>
      </div>
      <div className="flex flex-col gap-[104px]">
        <div className="flex gap-[220px]">
          ...
          <div className="flex gap-14">
            <div className="flex flex-col gap-4">
              ...
              {foodCategoryData.slice(0, 5).map((food, index) => (
            ...
            <div className="flex flex-col gap-4">
              <p className="text-[16px] text-[#71717A] text-transparent ">
                MENU
              </p>
              {foodCategoryData.slice(5, 10).map((food, index) => (
                <p className="text-white" key={index}>
                  {food.categoryName}
                </p>
              ))}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4">
              <Facebook className="text-white rounded" />
              <Instagram className="text-white rounded" />
            </div>
          </div>
          <div></div>
        </div>
        <div className="w-full">
          ...
          <div className="flex gap-12 text-[#71717A] w-full justify-self-start">
